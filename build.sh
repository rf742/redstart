...
cat src/red_errors.f90 build/staging/red_vector.f90 build/staging/red_random.f90 src/red_string.f90 src/red_datetime.f90 src/red_logger.f90 src/red_ioutil.f90 src/red_flag.f90 > build/redstart.f90
